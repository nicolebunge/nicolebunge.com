...
const ActingPage = ({ data }) => (
  <Layout>
    ...
    <Section>
      <Grid>
        <Gallery
          images={data.allFile.images.map(image => image.node.childImageSharp)}
        />
      </Grid>
    </Section>
      ...
      <Grid>
        <GridRow>
          ...
          <GridColumn columnSpan={3} columnStart={6}>
            <p>
              <strong>„Ein idealer Gatte“</strong>
              , Das junge Mädchen
              {' '}
              <br />
              Oscar Wilde
          ...
          <GridColumn columnSpan={3} columnStart={10}>
            <p>
              <strong>„Der Tor und der Tod“</strong>
              , Mabel Chiltern
              {' '}
              <br />
          ...
          <GridColumn columnSpan={3} columnStart={6}>
            <p>
              <strong>„Alice im Wunderland“</strong>
              , Alice
              {' '}
              <br />
          ...
          <GridColumn columnSpan={3} columnStart={6}>
            <p>
              <strong>„La Double Inconstance“</strong>
              , Silvia
              {' '}
              <br />
          ...
          <GridColumn columnSpan={3} columnStart={10}>
            <p>
              <strong>„Merlin oder das wüste Land“</strong>
              , Mordred
              {' '}
              <br />
              Tankred Dorst
          ...
          <GridColumn columnSpan={3} columnStart={6}>
            <p>
              <strong>„Bier für Frauen“</strong>
              , Eine Frau
              {' '}
              <br />
              Felicia Zeller
        ...
        <GridRow>
          ...
          <GridColumn columnSpan={3} columnStart={10}>
            ...
            <p>
              ...
              <br />
              <a
                href="http://www.attila-borlan.de"
                rel="noopener noreferrer"
                target="_blank"
              >
                Attila Borlan
          ...
          <GridColumn columnSpan={3} columnStart={6}>
            <h3>2017 - 2018</h3>
            <p>
              <strong>„Ein Mittsommernachtstraum“</strong>
              , Spinnweb &
              Krankenschwester
              {' '}
              <br />
...
export const pageQuery = graphql`
  query {
    allFile(filter: {relativePath: {in: ["alice.jpg", "berliner.jpg", "goth.jpg", "kompagnie-1.jpg", "kompagnie-2.jpg", "das-tote-maedchen.jpg"]}}) {
      images: edges {
        node {
          childImageSharp {
            fluid {
